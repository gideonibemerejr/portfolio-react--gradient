...
const Random = ({handleClick, isDarkMode}) => {
    return (
            ...
            xmlns="http://www.w3.org/2000/svg">
                ...
                stroke-width="3"
                />
                <path d="M0 0L3.57143 3.57143L7.7486e-05 7.14286" transform="translate(20.5713 14.8572)" stroke={isDarkMode ? 'white': 'black'} stroke-width="3"/>
                <path d="M0 12.3214C5.03247 12.3214 10.0649 9.91071 11.5747 6.16059C13.0844 2.41047 17.1104 7.37802e-05 22.1429 0" transform="translate(0.571289 18.4285) scale(1 -1)" stroke={isDarkMode ? 'white': 'black'} stroke-width="4"/>
                <path 
                fill-rule="evenodd" 
                clip-rule="evenodd" 
